 ...
 * Module reference: [Example 2: Structured Outputs (JSON Mode)](https://aitutorial.dev/prompting/structured-prompt-engineering#example-2-structured-outputs-json-mode)
