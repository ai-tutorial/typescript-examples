 ...
 * Module reference: [Example 2: Structured Outputs (XML Mode)](https://aitutorial.dev/prompting/structured-prompt-engineering#example-2-structured-outputs-xml-mode)
